...
local function list_all_plugins(only_enabled)
  ...
  local text = '<b>'..text..'</b>\n<b>There are</b> <code>'..nsum..'</code> <b>plugins installed.</b>\n<code>'..nact..'</code> <b>plugins enabled and</b> <code>'..nsum-nact..'</code> <b>disabled</b>'
  return text
end
...
local function list_plugins(only_enabled)
  ...
  local text = '<b>'..text..'</b>\n<code>'..nact..'</code> <b>plugins enabled from</b> <code>'..nsum..'</code> <b>plugins installed.</b>'
  return text
end
...
local function enable_plugin( plugin_name )
  ...
  if plugin_enabled(plugin_name) then
    return '<b>Plugin</b> <i>'..plugin_name..'</i> <b>is enabled</b>'
  end
  ...
  if plugin_exists(plugin_name) then
    ...
    return '<b>Plugin</b> <i>'..plugin_name..'</i> <b>does not exists</b>'
  end
end
...
local function disable_plugin( name, chat )
  ...
  if not plugin_exists(name) then
    return '<b>Plugin</b> <i>'..name..'</i> <b>does not exists</b>'
  end
  local k = plugin_enabled(name)
  -- Check if plugin is enabled
  if not k then
    return '<b>Plugin</b> <i>'..name..'</i> <b>not enabled</b>'
  end
  -- Disable and reload
...
local function disable_plugin_on_chat(receiver, plugin)
  ...
  save_config()
  return '<b>Plugin</b> <i>'..plugin..'</i> <b>disabled on this chat</b>'
end
...
local function reenable_plugin_on_chat(receiver, plugin)
  ...
  save_config()
  return '<b>Plugin</b> <i>'..plugin..'</i> <b>is enabled again</b>'
end
